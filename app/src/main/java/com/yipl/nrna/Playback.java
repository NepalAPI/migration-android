...
/**
 * Interface representing either Local or Remote Playback. The
 * {@link MediaService} works directly with an instance of the Playback
 * object to make the various calls such as play, pause etc.
 */
